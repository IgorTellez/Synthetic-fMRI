function strongSanlm(files2process)
...
matlabbatch{1}.spm.tools.cat.tools.sanlm.prefix = 'strong_';
...
matlabbatch{1}.spm.tools.cat.tools.sanlm.nlmfilter.optimized.NCstr = 4;
