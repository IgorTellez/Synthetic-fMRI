function lightSanlm(files2process)
...
matlabbatch{1}.spm.tools.cat.tools.sanlm.prefix = 'light_';
...
matlabbatch{1}.spm.tools.cat.tools.sanlm.nlmfilter.optimized.NCstr = 2;
